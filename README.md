...
# terraform-aws-msk-apache-kafka-cluster <a href="https://cpco.io/homepage"><img align="right" src="https://cloudposse.com/logo-300x69.svg" width="150" /></a>
...
| <a name="input_broker_ebs_provisioned_throughput_enabled"></a> [broker\_ebs\_provisioned\_throughput\_enabled](#input\_broker\_ebs\_provisioned\_throughput\_enabled) | Enable broker node EBS provisioned throughput for broker type kafka.m5.4xlarge or larger | `bool` | `false` | no |
| <a name="input_broker_ebs_provisioned_throughput_state"></a> [broker\_ebs\_provisioned\_throughput\_state](#input\_broker\_ebs\_provisioned\_throughput\_state) | Enable or disable provisioned throughput of the EBS volumes for the data drive on kafka broker nodes | `bool` | `false` | no |
| <a name="input_broker_ebs_provisioned_throughput_value"></a> [broker\_ebs\_provisioned\_throughput\_value](#input\_broker\_ebs\_provisioned\_throughput\_value) | Provisioned throughput value of the EBS volumes for the data drive on kafka broker nodes in MiB per second | `number` | `250` | no |
